...
void loop(){
  ...
  //Serial.println(tic);
    ...
    else if(tiempoPrograma<(tAcl+tDes+tAcl)*60000){
      Paso=Aclarado2;
      Lavar();
      }
    else if(tiempoPrograma<(tAcl+tDes+tAcl+tDes)*60000){
      Paso=Desague4;
      Desague();
      }
    else if(tiempoPrograma<(tAcl+tDes+tAcl+tDes+tAcl)*60000){
      Paso=Aclarado3;
      Lavar();
      }
    else if(tiempoPrograma<(tAcl+tDes+tAcl+tDes+tAcl+tDes)*60000){
      Paso=Desague5;
      Desague();
      }
    else if(tiempoPrograma<(tAcl+tDes+tAcl+tDes+tAcl+tDes+tCen)*60000){
      Paso=Centrifugado;
      Desague();
      }
    else{
